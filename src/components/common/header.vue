  ...
  data() {
    return {
      ...
      items: [
        ...
        {
          cls: "理化前处理",
          des: ["有机样品前处理", "无机样品前处理", "实验室设备", "配件及耗材"],
          third: [
            [
              "HPSE高效快速溶剂萃取系统",
              "全自动均质系统",
